 ...
 * @author alphaoumar
 */
public class Variante1 extends javax.swing.JFrame {
    //etats possibles
    private enum state{INIT, RED, GREEN, ORANGE, PANNEON, PANNEOFF}
    //etat courant
    private state currentState;
    //evenement buttonStart, buttonStop, buttonPanne
    private Timer tRed, tGreen, tOrange, tPanneOn, tPanneOff;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Variante1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
