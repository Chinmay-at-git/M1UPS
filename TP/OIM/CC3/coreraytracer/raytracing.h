 ...
 */
  ...
  */
  ...
  /**
     to create an intersection CSG Node.
     @param a
     @param b
     @return a new geometry that is the intersection of a and b
  */
  Geometry *create_csg_intersection(Geometry *a, Geometry *b);
  /**
     to create an union CSG Node.
     @param a
     @param b
     @return a new geometry that is the union of a and b
  */
  Geometry *create_csg_union(Geometry *a, Geometry *b);

  /**
     to create a difference CSG Node.
     @param a
     @param b
     @return a new geometry that is the difference of a and b
  */
  ...
  */
  ...
  /**
     ...
     @param ks_r_ the color of the reflective layer
     @param ks_g_
     @param ks_b_
